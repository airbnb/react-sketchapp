...
export function makeBoundingRectFromPoints(points: [Point]): SJRect {
...
export function makeBoundingRectFromCommands(commands): SJRect {
...
export function unionRects(...rects: [SJRect]): SJRect {
  function union(a: SJRect, b: SJRect): SJRect {
...
export function scaleRect(rect: SJRect, scale: number): SJRect {
