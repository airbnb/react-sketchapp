...
/***/ function(module, exports, __webpack_require__) {
	...
	var cocoaEqual = function cocoaEqual(a, b) {
	  return a == b;
	}; // eslint-disable-line
	...
	var onRun = function onRun(context) {
	  ...
	  var typeLabel = utils.createLabel(NSMakeRect(0, viewHeight - 20, viewWidth, 20), 'Type');
	  view.addSubview(typeLabel);

	  var typeTextField = NSTextField.alloc().initWithFrame(NSMakeRect(0, viewHeight - 40, viewWidth, 20));
	  typeTextField.setStringValue('Rect');
	  view.addSubview(typeTextField);

	  var propsLabel = utils.createLabel(NSMakeRect(0, viewHeight - 80, viewWidth, 20), 'Props');
	  view.addSubview(propsLabel);

	  var propsTextView = NSTextView.alloc().initWithFrame(NSMakeRect(0, viewHeight - 120, viewWidth, 40));
	  ...
	  if (cocoaEqual(response, 1000)) {
	    var rawProps = propsTextView.string();
	    var props = JSON.parse(rawProps);
	    var type = typeTextField.stringValue();
